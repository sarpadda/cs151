...
public class Connection
{
   ...
   @param key the phone key pressed by the user
	...
	private void findmail(String key)
	{
		if (key.equals("#"))
		{
			currentMailbox = system.findMailbox(accumulatedKeys);
	...
	private void whatYouWant(String key)
	{
		if (key.equals("1"))
		{
			state=CONNECTED;
  ...
  @param key the phone key pressed by the user
	...
	private static final int FINDMAILBOX = 9;
